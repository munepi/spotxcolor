...
\item \textbf{Universal Engine Support:} All standard macros (|\color|, |\textcolor|, |\pagecolor|) produce true spot color output on all four engines (pdfTeX, LuaTeX, XeTeX, dvipdfmx) via automatic interception. No special commands or driver options are required.
