...
\textsf{spotxcolor} detects pdfmanagement at load time by checking the internal boolean |\g__pdfmanagement_active_bool| and automatically switches its resource registration strategy:
...
\hline
pdfmanagement active & |\pdfmanagement_add:nnx| \\
