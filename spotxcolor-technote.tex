...
v1.5 introduces a boolean flag |\g__spotxcolor_pdfmanagement_bool|, detected at package load time via |\IfPDFManagementActiveTF|, and rewires the centralized resource helper |\spotxcolor_add_colorspace_resource:nn|:
