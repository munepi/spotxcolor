...
\begin{tabular}{ll}
\hline
\textbf{Driver} & \texttt{\textbackslash\textbackslash color@Plum} expands to \\
\hline
dvips   & |rgb 0.5 0 1| \\
...
\begin{enumerate}
\item \textbf{Driver-spec opacity:}
...
\item \textbf{Type dispatch fragility:}
...
\item \textbf{Historical instability:}
